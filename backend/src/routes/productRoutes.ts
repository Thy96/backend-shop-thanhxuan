...
import { getAll, postProduct, getProductById, updateProduct, getTrashProducts, forceDeleteProduct, moveProductToTrash, restoreProduct, getPublishProducts } from "../controllers/productController";
